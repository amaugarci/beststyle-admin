<template>
   <div class="absolute z-[99991] px-[29px] py-[18px] w-[980px] h-[670px] bg-[#FFFFFF] fixed top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2">
      ...
      <div class="w-full flex justify-center mt-[50px]">
        <div class="w-[825px] flex items-center gap-1 overflow-x-auto">
          <div v-for="(item,index) in images" class="w-[150px] h-[200px] relative">
            <BIconXCircle ref="deleteimage" class="absolute right-[0px] text-[20px] cursor-pointer text-[#FF0000]" @click="()=>removeImage(index)"/>
            <img :src="item" class="w-[140px] h-[190px] mt-[10px]"/>
          </div>
